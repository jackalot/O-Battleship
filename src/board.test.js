...
test.skip("[1,1] is equal to the bottom left corner, [1, 1]", () => {
    expect(mockBoard.checkEqualToBLC({x: 1, y: 1})).toBe(true);
})
test.skip("[1,7] is equal to the bottom left corner, [1, 1]", () => {
    expect(mockBoard.checkEqualToBLC({x: 1, y: 7})).toBe(false);
})
test.skip("[1,1] is greater than the bottom left corner, [1, 1]", () => {
    expect(mockBoard.checkGreaterThanBLC({x: 1, y: 1})).toBe(false);
})
test.skip("[1,7] is greater than the bottom left corner, [1, 1]", () => {
    expect(mockBoard.checkGreaterThanBLC({x: 1, y: 7})).toBe(true);
})
// ]?
test.skip("[1,1] is not equal to the top right corner, [10, 10]", () => {
    expect(mockBoard.checkEqualToTRC({x:1, y: 1})).toBe(false);
})
test.skip("[1,7] is not equal to the top right corner, [10, 10]", () => {
    expect(mockBoard.checkEqualToTRC({x:1, y: 7})).toBe(false);
})
test.skip("[1,1] is not greater than the top right corner, [10, 10]", () => {
    expect(mockBoard.checkLessThanTRC({x:1, y: 1})).toBe(true);
})
test.skip("[1,7] is not greater than the top right corner, [10, 10]", () => {
...
test.skip("[1,7] is a valid according to the Bottom Left Corner", () => {
    expect(mockBoard.checkBottomLeftCorner({x: 1, y: 7})).toBe(true);
})
test.skip("[1,1] is a valid according to the Top Right Corner", () => {
    expect(mockBoard.checkTopRightCorner({x: 1, y: 1})).toBe(true);
})
test.skip("[1,7] is a valid according to the Top Right Corner", () => {
    expect(mockBoard.checkTopRightCorner({x: 1, y: 7})).toBe(true);
})
test.skip("[1,1] is a valid coordinate on the game board", () => {
    expect(mockBoard.checkValidCoord({x: 1, y: 1})).toBe(true);
})
test.skip("[1,7] is a valid coordinate on the game board", () => {
    expect(mockBoard.checkValidCoord({x: 1, y: 7})).toBe(true);
})
test.skip("gameBoard has placed a ship from [1,1] to [1,7]", () => {
    expect(mockBoard.placeShip({x: 1, y: 1}, {x: 1, y: 7})).toMatchObject({ coord1: {x: 1, y: 1}, coord2: {x: 1, y: 7} });
})
test.skip("gameBoard has placed a ship from [9,3] to [9,9]", () => {
...
test.skip("gameBoard checks if 2, 5 has a hit or miss on it already", () => {
    expect(mockBoard.checkAvailableCoord({x: 2, y: 5})).toBe(true);
})
test.skip("gameBoard checks if a ship is at 1,1 and returns its coordinates as there is a ship there", () => {
    expect(mockBoard.findFirstShip({x:1, y:1})).toMatchObject({coord1: {x: 1, y: 1}, coord2: {x: 1, y: 7}});
})
test.skip("gameBoard checks if a ship is at 9,3 and returns true as there is a ship there", () => {
...
test.skip("[10,10] is a valid coordinate on the game board", () => {
    expect(mockBoard.checkValidCoord({x: 10, y: 10})).toBe(true);
})
test.skip("[10,1] is a valid coordinate on the game board", () => {
    expect(mockBoard.checkValidCoord({x: 10, y: 1})).toBe(true);
})
test.skip("[10,1] is not out of bounds of the bottom left corner", () => {
    expect(mockBoard.checkBottomLeftCorner({x: 10, y: 1})).toBe(true);
})
test.skip("[10,1] is not out of bounds of the top right corner", () => {
    expect(mockBoard.checkTopRightCorner({x: 10, y: 1})).toBe(true);
})
test.skip("[10,1] is on the line of the top right corner", () => {
...
test.skip("[5,5] will return a miss as there is not a ship there", () => {
